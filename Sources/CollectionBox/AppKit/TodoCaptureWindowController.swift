...
///
/// WorkBuddy panel pattern: floating, fixed 360×420 frame, rebuilt (fresh
/// @State) on every open. No frame autosave — autosave is only used by the
/// regular Dashboard window.
final class TodoCaptureWindowController: NSObject {
